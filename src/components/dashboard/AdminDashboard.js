        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh] p-6">
                <div className="text-center max-w-xs w-full">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 leading-relaxed">This page is restricted to administrators.</p>
                </div>
            </div>
        );
    }
        ...
        >
            <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
                ...
                <div className="relative rounded-2xl overflow-hidden">
                    ...
                    <div className="absolute -right-8 -top-8 w-40 h-40 rounded-full bg-blue-400/10 pointer-events-none" />
                    <div className="absolute right-20 bottom-0 w-24 h-24 rounded-full bg-indigo-400/10 pointer-events-none" />
